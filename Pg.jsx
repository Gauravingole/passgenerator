...
function Pg() {
   ...
   useEffect(()=>{
    passgenerator()
   },[length,addnumber,addchar,passgenerator])
   ...
   const copytoclipboard = useCallback(()=>{
    ...
    refrence.current?.setSelectionRange(0,7)
   },[password])

   return (
        <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-3 bg-gray-800 text-yellow-500">
